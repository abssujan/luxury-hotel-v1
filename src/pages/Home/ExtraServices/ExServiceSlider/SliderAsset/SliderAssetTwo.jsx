import food from '../../../../../assets/sliderAsset/food.jpg'
import locker from '../../../../../assets/sliderAsset/locker.jpg'

const SliderAssetTwo = () => {
    return (
        ...
        <div className="max-w-[720px] mx-auto">
          ...
          <div className="relative flex flex-col text-gray-700 bg-[#f8f5f0] shadow-md bg-clip-border rounded-xl w-96">
            <div className="relative overflow-hidden text-gray-700 bg-white bg-clip-border  h-fit">
              <img src={food} alt="card-image" className=" w-full h-full" />
            </div>
            <div className="p-10">
              {/* heading */}
              <div>
      ...
      <div className="">
        <div className="max-w-[720px] mx-auto">
          ...
          <div className="relative flex flex-col text-gray-700 bg-[#f8f5f0] shadow-md bg-clip-border rounded-xl w-96">
            <div className="relative overflow-hidden text-gray-700 bg-white bg-clip-border  h-fit">
              <img src={locker} alt="card-image" className=" w-full h-full" />
            </div>
            <div className="p-10">
              {/* heading */}
              <div>
